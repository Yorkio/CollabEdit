...
def edit(tb, fn, message):
    ...
    try:
        ...
        #action = message[1]
        if message[1] == '1':
            tb.mark_set(INSERT, str(line + 1) + '.' + str(position + 1))
        elif message[1] == '0':
            tb.mark_set(INSERT, str(line + 1) + '.' + str(position))
        elif message[1] == '3':
            tb.mark_set(INSERT, str(line + 1) + '.' + str(position + 1))
...
class Editor:
    ...
    def open_command(self):
        ...
        print list_of_files, 'list of files'
    ...
    def create_command(self):
        ...
        def get_filename():
            ...
            if response == '1':
                ...
                return
            # Create a file
            open(self.active_filename, 'a').close()
            self.filename_label.config(text='Editing: ' + basename(self.active_filename))
            self.textPad.delete('1.0', END)
            self.child.destroy()
